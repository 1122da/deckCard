...
const App = ({}) => {
  ...
  async function getCard(value) {
    try {
      var url =
        'https://deckofcardsapi.com/api/deck/kzrsddfawusu/draw/?count=1';
  ...
  function animateMe(value) {
    if (value === 'first') {
      ...
      Animated.timing(turnSecondValue, {
        toValue: 1,
        duration: 500,
        easing: Easing.linear,
        useNativeDriver: true,
  ...
  return (
    <View style={styles.container}>
      {showCard ? null : (
        <Button title="Show Card" onPress={() => setShowCard(true)} />
      )}
      ...
      {showCard ? (
        <>
          <TouchableOpacity
            ...
            {!showFace ? (
              <Animated.View
                style={[styles.card, {transform: [{rotateY: turn}]}]}>
              ...
              <Animated.View
                style={[styles.face, {transform: [{rotateY: turn}]}]}>
          ...
          <TouchableOpacity
            ...
            {!showSecondFace ? (
              <Animated.View
                style={[styles.card, {transform: [{rotateY: turn_second}]}]}>
                <Line rotation={'120deg'} alignSelf={'center'} width={400} />
                <Line rotation={'80deg'} alignSelf={'center'} width={400} />
                <Line rotation={'50deg'} alignSelf={'center'} width={400} />
              </Animated.View>
              ...
              <Animated.View
                style={[styles.face, {transform: [{rotateY: turn_second}]}]}>
